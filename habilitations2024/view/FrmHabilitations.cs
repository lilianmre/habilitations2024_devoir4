...
namespace habilitations2024.view
{
    ...
    public partial class FrmHabilitations : Form
    {
        ...
        private void RemplirListeDeveloppeurs()
        {
            ...
            if (cboFiltreProfil.SelectedIndex > 0)
            {
                Profil profil = (Profil)cboFiltreProfil.SelectedItem;
                lesDeveloppeurs = controller.GetLesDeveloppeurs(profil.Idprofil);
            }
            else
            {
        ...
        /// <summary>
        /// Remplit le combo box de filtrage des profils
        /// </summary>
        private void RemplirComboFiltreProfil()
        {
            List<Profil> lesProfils = controller.GetLesProfils();
            lesProfils.Insert(0, new Profil(0, ""));
            cboFiltreProfil.DataSource = lesProfils;
            cboFiltreProfil.DisplayMember = "Nom";
            cboFiltreProfil.SelectedIndex = 0;
        }

        /// <summary>
        /// Gère le changement de sélection dans le combo box de filtrage
        /// </summary>
